...
It has also notable limitations, both fundamental (the suitability
...
interactions, appears in children around their third year. It supposes the
...
communication between modules are in fact supported by the knowledge base in
...
presented here: first, the \emph{architect perspective}: what are the pro and
cons of our approach from an engineer's point of view. Then, the \emph{logician
perspective}: does the promise of automated reasoning for robots really comes
